 ...
 */
public class ProductsWishlistController extends BaseController {

    private ProductWebapi mProductWebapi;
    private ProductManager mProductManager;

    public ProductsWishlistController(SpiceManager spiceManager) {
    ...
    public List<Product> getProductsWishlist() {
        return mProductManager.getProductsWishlist();
    }
