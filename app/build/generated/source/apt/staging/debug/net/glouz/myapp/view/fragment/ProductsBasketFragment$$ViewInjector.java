...
public class ProductsBasketFragment$$ViewInjector<T extends net.glouz.myapp.view.fragment.ProductsBasketFragment> implements Injector<T> {
  @Override public void inject(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131558562, "field 'mproductBaGridView'");
    target.mproductBaGridView = finder.castView(view, 2131558562, "field 'mproductBaGridView'");
  }
