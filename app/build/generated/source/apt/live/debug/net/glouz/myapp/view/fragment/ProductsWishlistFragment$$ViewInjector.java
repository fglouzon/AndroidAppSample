...
public class ProductsWishlistFragment$$ViewInjector<T extends net.glouz.myapp.view.fragment.ProductsWishlistFragment> implements Injector<T> {
  @Override public void inject(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131230840, "field 'mWishlistGridView'");
    target.mWishlistGridView = finder.castView(view, 2131230840, "field 'mWishlistGridView'");
  }
