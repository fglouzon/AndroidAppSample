...
public class NavigationDrawerFragment$$ViewInjector<T extends net.glouz.myapp.view.fragment.NavigationDrawerFragment> implements Injector<T> {
  @Override public void inject(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131230821, "field 'mListNavigationDrawer'");
    target.mListNavigationDrawer = finder.castView(view, 2131230821, "field 'mListNavigationDrawer'");
  }
